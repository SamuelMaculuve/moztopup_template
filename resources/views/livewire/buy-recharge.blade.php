<div class="row d-flex justify-content-center align-items-center">
    <!-- Left -->
    <div class="col-lg-6">
        <div class="row d-none d-lg-flex d-md-flex mb-2 gap-2 mx-1 justify-content-center"
            style="background-color: white; border-radius: 5px;">
            <div class="col-lg-3 col-sm-6 p-2">
                <div class="item">
                    {{-- <center> --}}
                    <img style="width: 90%;" src="{{ asset('storage/images/games/' . $game->image) }}"
                        alt="">
            ...
            <div class="col-lg-3 col-sm-6 p-2">
                <div class="item">
                    {{-- <center> --}}
                    <img style="width: 50%;"
                        src="https://cdn1.codashop.com/S/content/common/images/denom-image/LOLWR/50x50/3_LOLWR_WildCore.png"
                        alt="">
        ...
        <div class="card position-sticky top-0">
            <div class="p-3 bg-light bg-opacity-10">
                ...
                <div class="d-flex justify-content-between mb-4 small">
                    <span>TOTAL</span> <strong class="text-dark">{{ number_format($rechargeType->price) }}
                        MZN
                        {{ $data }}</strong>
                </div>
                <div class="form-check mb-1 small">
                    ...
                    <label class="form-check-label" for="tnc">
                        Aceito e concordo com os <a href="#" class="text-info">termos e
                            condic&otilde;es</a>
                    </label>
                </div>
                ...
                <button wire:click="makePaymentRequest" class="btn btn-primary w-100 mt-2">Pagar</button>
            </div>
        </div>
    </div>
</div>
