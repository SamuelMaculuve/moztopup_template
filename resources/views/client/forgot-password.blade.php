              ...
              <div class="col-lg-10 col-md-9 col-xl-6 mx-auto ms-xl-0">
                ...
                <div class="mt-10 mt-lg-5 mb-6 d-lg-block">
                  <span class="d-inline-block d-lg-block h1 mb-4 mb-lg-6 me-3"
                    >🗝</span
                  >
                  <h1 class="ls-tight font-bolder h2">Esqueceu a Password!</h1>
                </div>
                <form action="{{ route('password.email') }}" method="POST">
                    @csrf
                  <div class="mb-5">
                    <h6>Preencha o seu email e clique no link enviado na sua caixa postal para recuperar a senha.</h6>
                </div>
                <div class="mb-5">
                ...
                <div>
                    <button type="submit" class="btn btn-primary w-full">Recuperar</button>
                  </div>
                </form>
              </div>
            </div>
